...
#End Region
    ...
    Public Sub New(ByRef lblMPH_IN As Label, ByRef lblGear_IN As Label, ByRef TextBox2_IN As System.Windows.Forms.TextBox, ByRef TextBox3_IN As System.Windows.Forms.TextBox, ByRef TextBox4_IN As System.Windows.Forms.TextBox, ByRef SpeedGauge As PictureBox, ByRef RPMGauge As PictureBox, ByRef ParkingBrakeLight As PictureBox, ByRef DriveIndicator As Label, ByRef RightBlinker As PictureBox, ByRef LeftBlinker As PictureBox, ByRef TurnStockDefault As PictureBox, ByRef TurnStockDown As PictureBox, ByRef TurnStockUp As PictureBox, ByRef LowBeams As PictureBox, ByRef HighBeams As PictureBox, ByRef FogLights As PictureBox, ByRef ClockBox As PictureBox)
